...
namespace KN_Lights {
  public class LightsSet {
    ...
    public void Attach(Quality quality, bool own, KnCar car, bool tailLights, Color debug) {
      ...
      MakeLights(tailLights, ilEnabled);

      Enabled = true;
    }

    private void Initialize(Color debug, bool il) {
      Dispose();
    ...
    private void MakeLights(bool tailLights, bool illumination) {
